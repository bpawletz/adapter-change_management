...
class ServiceNowAdapter extends EventEmitter {
    ...
    healthcheck(callback) {
        this.postRecord((result, error) => {
            ...
            if (error) {
                ...
                this.emitOffline();
                log.error(`ServiceNow: Instance is offline. | Reason: ${error} | Instance id: ${this.id}`);
                return error;
    ...
    emitOffline() {
        ...
        log.warn(`ServiceNow: Instance is unavailable. | Instance id: ${this.id}`);
    }
    ...
    emitOnline() {
        ...
        log.info(`ServiceNow: Instance is available. | Instance id: ${this.id}`);
    }
