...
class ServiceNowConnector {
    ...
    get(callback) {
        ...
        this.sendRequest(getCallOptions, (results, error) => callback({ method: getCallOptions.method, response: results }, error));
    }
    ...
    post(callback) {
        ...
        this.sendRequest(postCallOptions, (results, error) => callback({ method: postCallOptions.method, response: results }, error));
    }
